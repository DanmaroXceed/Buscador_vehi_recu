        ...
        try {
            ...
            DB::transaction(function () use ($data) {
                ...
                $vehiculo = Vehiculo::create([
                    'fecha_ingreso'        => $data[2],                             // [2] FECHA RECUPERACION
